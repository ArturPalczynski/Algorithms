...
public class Kruskal {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < inputEdges.size(); i++) {
			...
			if(minimalSpanningTree.get(i).getMembershipFlag() == inputEdges.get(i).getMembershipFlag()){
		...
		//TODO
		//Napisaæ funkcjê która sprawdza czy wierzcho³ki nowo dodawanej krawêdzi maj¹ obydwie falgi z tego samego drzewa
		//jeœli tak to j¹ od¿ucamy a jeœli nie to dodajemy je do minimalnego drzewa i zmieniamy falgi na takie 
